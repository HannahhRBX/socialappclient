                ...
                {Array.isArray(Matches) && Matches.map((match, index) => {
                    ...
                    if (match == null) {
                        ...
                        return (
                            ...
                            <div onClick={() => window.location.href=`https://grand-sunshine-1957f1.netlify.app/users/${match._id}`} style={{ borderRadius:'10px', textDecoration: 'none', cursor: 'pointer' }} className="hover:bg-[#eaeaea]">
